...
def ExtractFeaturesForFile(f):
  command = ['nodejs', '--max_old_space_size=64000', 'bin/unuglifyjs', f, '--extract_features', '--max_path_length=' + str(MAX_PATH_LENGTH), '--skip_minified', "--to_glove", '--max_path_width=' +str(MAX_PATH_WIDTH), '--semi_paths']
