...
def PrintUsage():
  print """
Usage:
  extract_features_giv.py --filelist <file> --max_path_length <number> --max_path_width <number>
OR
  extract_features_giv_giv.py --dir <directory> --max_path_length <number> --max_path_width <number>
"""
  exit(1)
...
def ExtractFeaturesForFile(f):
  command = ['nodejs', '--max_old_space_size=64000', 'bin/unuglifyjs', f, '--extract_features', '--max_path_length=' + str(MAX_PATH_LENGTH), '--skip_minified', "--include_giv_giv", '--max_path_width=' +str(MAX_PATH_WIDTH)]
